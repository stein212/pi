...
- Fixed `Text` padding and background rendering on very narrow terminals so `Text`-based components such as `Loader` do not emit lines wider than the terminal.
